              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <Progress value={proteinPercentage} className="h-2 bg-gray-200 [&>div]:bg-blue-500" />
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                    ...
                    <Progress value={carbsPercentage} className="h-2 bg-gray-200 [&>div]:bg-green-500" />
                  </div>
                  <div>
                    <div className="flex justify-between mb-1">
                    ...
                    <Progress value={fatPercentage} className="h-2 bg-gray-200 [&>div]:bg-yellow-500" />
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        {meal.foods.map((food, foodIndex) => (
                            <div key={foodIndex} className="py-1 border-b last:border-0">
                              ...
                              <div className="text-sm text-gray-600 mt-1">
                                ...
                                <span className="ml-4">Carbs: {food.carbs}g</span>
                                <span className="ml-4">Fat: {food.fat}g</span>
                              </div>
                            </div>
                        ))}
                      </div>
